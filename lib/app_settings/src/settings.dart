...
final class Preferences {
  ...
  final videoRegularCmd =
      'yt-dlp --verbose --format "bestvideo[width<=1920][height<=1080][fps<=60]+bestaudio[audio_channels<=2][asr<=48000]" --output "%(title)s" --restrict-filenames --merge-output-format mkv --write-auto-subs --embed-thumbnail --convert-thumbnail png --embed-metadata --sub-lang "en.*" --fragment-retries 999 --retries 999 --extractor-retries 0 "https://www.youtube.com/watch?v=jJWvIm8ZVCI"';
  /*   'yt-dlp --verbose --paths "<output_dir>" --format "bestvideo[width<=1920][height<=1080][fps<=60]+bestaudio[audio_channels<=2][asr<=48000]" --output "%(title)s" --restrict-filenames --merge-output-format mkv --write-auto-subs --embed-thumbnail --convert-thumbnail png --embed-metadata --sub-lang "en.*" --fragment-retries 999 --retries 999 --extractor-retries 0 "https://www.youtube.com/watch?v=<video_id>"'; */
