...
final class Preferences {
  ...
  final videoPreferredCmd =
      'yt-dlp --verbose --paths "<output_dir>" --format "bestvideo[width<=<pref_width>][height<=<pref_height>][fps<=60][vcodec^=av01]+bestaudio[acodec=opus][audio_channels<=2][asr<=48000]" --output "%(title)s" --restrict-filenames --merge-output-format mkv <write_auto_subs> --embed-thumbnail --convert-thumbnail png --embed-metadata --sub-lang "en.*" --write-subs --progress-template {\'percentage\':\'%(progress._percent_str)s\',\'bytes_downloaded\':\'%(progress._downloaded_bytes_str)s\',\'bytes_total\':\'%(progress._total_bytes_str)s\',\'download_speed\':\'%(progress._speed_str)s\',\'ETA\':\'%(progress._eta_str)s\'} --fragment-retries 2147483647 --retries 2147483647 --extractor-retries 0 <cookie_arg> "https://www.youtube.com/watch?v=<video_id>"';
  final videoRegularCmd =
      'yt-dlp --verbose --paths "<output_dir>" --format "bestvideo[width<=<pref_width>][height<=<pref_height>][fps<=60]+bestaudio[audio_channels<=2][asr<=48000]" --output "%(title)s" --restrict-filenames --merge-output-format mkv <write_auto_subs> --embed-thumbnail --convert-thumbnail png --embed-metadata --sub-lang "en.*" --write-subs --progress-template {\'percentage\':\'%(progress._percent_str)s\',\'bytes_downloaded\':\'%(progress._downloaded_bytes_str)s\',\'bytes_total\':\'%(progress._total_bytes_str)s\',\'download_speed\':\'%(progress._speed_str)s\',\'ETA\':\'%(progress._eta_str)s\'} --fragment-retries 2147483647 --retries 2147483647 --extractor-retries 0 <cookie_arg> "https://www.youtube.com/watch?v=<video_id>"';
